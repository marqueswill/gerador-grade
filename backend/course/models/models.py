...
class Course(models.Model):
    ...
    def append_subject(self, semester, subject, status):
        course_subject = CourseSubject(
            course=self, subject=subject, semester=semester, status=status
        )
        course_subject.save()
...
class Subject(models.Model):
    ...
    #             grade_infos[semester_grade.semester]["grades"][
    #                 "ss"
    #             ] += semester_grade.ss
    #             grade_infos[semester_grade.semester]["grades"][
    #                 "ms"
    ...
    #             ] += semester_grade.tj
    #         else:
    #             grade_infos[semester_grade.semester] = {
    #                 "semester": semester_grade.semester,
    #                 "grades": {
...
class CourseSubject(models.Model):
    ...
    course = models.ForeignKey(
        Course, on_delete=models.CASCADE, related_name="course_subject"
    )
    subject = models.ForeignKey(
        Subject, on_delete=models.CASCADE, related_name="course_subject"
    )
...
class CourseCurriculum(models.Model):
    course = models.ForeignKey(
        Course, on_delete=models.CASCADE, related_name="course_curriculum"
    )
    subject = models.ForeignKey(
        Subject, on_delete=models.CASCADE, related_name="course_curriculum"
    )
...
class Option(models.Model):
    ...
    def to_json(self):
        return {"code": self.course.code, "name": self.course.name}
