    ...
    for curriculum_id in active_curriculum_ids:
        ...
        for curr_subject in optional_subjects_info:
            ...
            try:
                ...
                print(
                    f"    Could not find subject {curr_subject['name']}: {error}. Trying to create it"
                )
                ...
                try:
                    ...
                    try:
                        ...
                        subject.save()
                        print(
                            f"Subject {curr_subject['name']} created without department"
                        )
                    except Exception as error:
                        # If all of the above fails, skip to the next subject
                        print(
                            f"Could not create subject {curr_subject['name']}: {error}. Skipping subject"
                        )
                        continue
                ...
                try:
                    ...
                    print(
                        f"    Could not create subject {curr_subject['name']}: {error}. Skipping iteration"
                    )
                    continue
            ...
            try:
                ...
                print(
                    f"    Could not link subject {curr_subject['name']} with its course"
                )
                continue
