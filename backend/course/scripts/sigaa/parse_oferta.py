        ...
        # Se não for agrupador, é a td com as demais informações
            ...
            try:
                ...
                try:
                    ...
                    print(
                        f'Não foi possível encontrar a disciplina{turmas["subject_code"]}'
                    )
                    infos_list = []
                    turma = turma.find_next_sibling("tr")
                    continue
                ...
                try:
                    ...
                    print(
                        f'Erro ao criar ou dar get turma com o nome {turmas["name"]} na disciplina {turmas["subject_code"]}'
                    )
                    infos_list = []
                    turma = turma.find_next_sibling("tr")
                    continue
                ...
                try:
                    ...
                    try:
                        ...
                        print(e)
                        print(
                            f'Erro ao vincular {turmas["teacher"]} e {turmas["subject_code"]}-{turmas["name"]}'
                        )
                        infos_list = []
                        turma = turma.find_next_sibling("tr")
                        continue
                    ...
                    print(
                        f'Erro ao criar ou dar get no professor {turmas["teacher"]} da turma {turmas["subject_code"]}-{turmas["name"]}'
                    )
                    infos_list = []
                    turma = turma.find_next_sibling("tr")
                    continue
                ...
                print(e)
                print(
                    f'A oferta para {turmas["subject_code"]}-{turmas["subject_name"]} já existe no banco de dados'
                )
                infos_list = []
                turma = turma.find_next_sibling("tr")
                continue
                ...
                print(e)
                print(
                    f'A oferta para {turmas["subject_code"]}-{turmas["subject_name"]} não foi encontrada'
                )
                infos_list = []
                turma = turma.find_next_sibling("tr")
                continue
